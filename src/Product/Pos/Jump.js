...
const Jump = () => {
  return (
    <div className="row p-3">
      <a className="btn" data-bs-toggle="modal" data-bs-target="#toko">
        <svg
      ...
      <a className="btn" data-bs-toggle="modal" data-bs-target="#resto">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="26"
          height="26"
      ...
      <a className="btn " data-bs-toggle="modal" data-bs-target="#online">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="26"
          height="26"
      ...
      <a className="btn" data-bs-toggle="modal" data-bs-target="#share">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="26"
          height="26"
