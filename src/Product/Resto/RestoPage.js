...
const RestoPage = ({ match }) => {
  const name = match.params.name;
  const article = RestoContent.find(article => article.name === name);
  return (
    <>
      <div className="row">
        <Link to="/aplikasirestoran" className="btn">
          <svg
        ...
        <div className="col-12 col-md-4 p-3 p-md-5 text-center">
          ...
          <div className="row">
            <div className="col-12 col-md-12 text-center">
              <Link
                to="/orderapp"
                className="btn btn-block btn-lg btn-dark p-3"
              >
                Order Now
              </Link>
            </div>
